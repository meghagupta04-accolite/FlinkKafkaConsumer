...
public class ConfigConstants {
	...
	public static final String CONFIG_FILE_LOCATION = "D:\\prudentialworkspace\\FlinkKafkaConsumer\\BankConfig_acc_Collection1.xlsx";
	...
	public static final String BANK_INPUT_FILE_NAME ="D:\\DropZone\\BANK_INPUT\\PT29040004"+new SimpleDateFormat("dd-MM-yy HH-mm-ss").format(new Date())+".DAT"; 
	public static final String IL_RESP_FILE_NAME ="D:\\DropZone\\IL_OUTPUT\\ILFlatFile"+new SimpleDateFormat("dd-MM-yy HH-mm-ss").format(new Date())+".txt"; 
